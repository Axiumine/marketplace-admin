import { urlMappa } from '@/lib/nominatim'
 ...
 */
export const MappaIndirizzo = ({ lat, lon, titolo }: { lat: number; lon: number; titolo: string }) => (
	<>
		...
		<iframe title={titolo} src={urlMappa(lat, lon)} height={400} className="w-full rounded-box border border-tip" />
