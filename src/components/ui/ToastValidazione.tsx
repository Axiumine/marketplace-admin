...
export const INTESTAZIONE_VALIDAZIONE = 'Correggi questi campi prima di salvare:'
 ...
 */
export const ToastValidazione = ({ errori }: { errori: FieldErrors }) => {
	const messaggi = messaggiDaCorreggere(errori)

	if (messaggi.length === 0) return null

	return (
		<Toast tone="error">
			<span className="font-semibold">{INTESTAZIONE_VALIDAZIONE}</span>
