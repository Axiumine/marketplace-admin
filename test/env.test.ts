		...
		expect(
			readEnv(
				source({
					...
					VITE_GRAPHQL_ENDPOINT_ADMIN_AUTHENTICATED_AUTHORIZATION: '/a-auth',
					VITE_GRAPHQL_ENDPOINT_ADMIN_AUTHENTICATED_RESOURCE: '/a-res',
		...
		expect(
			readEnv(
				source({
					...
					VITE_GRAPHQL_ENDPOINT_ADMIN_AUTHENTICATED_AUTHORIZATION: '',
					VITE_GRAPHQL_ENDPOINT_ADMIN_AUTHENTICATED_RESOURCE: '',
