...
export const ADMIN: AdminIdentity = { _id: '65f0000000000000000000a1', email: 'admin@marketplace.it' }
 ...
 *
 * Pages are tested through the router rather than in isolation because the URL *is* their input: the
 * table's page, sort and search all arrive as validated search params, and mounting the page component
 * by hand would test it against props no user can produce.
 */
