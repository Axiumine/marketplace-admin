 ...
 * again in the validation toast that lists every one of them. A bare `screen.getByText(messaggio)` sees
 ...
 * assert one is gone.
 */
export const pagina = (): BoundFunctions<typeof queries> => within(screen.getByRole('main'))
